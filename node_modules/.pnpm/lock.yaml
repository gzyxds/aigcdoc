...
importers:
  ...
  .:
    ...
    devDependencies:
      ...
      vitepress:
        specifier: ^1.3.4
        version: 1.4.0(@algolia/client-search@4.24.0)(postcss@8.4.47)(sass@1.79.4)(search-insights@2.17.2)
...
packages:
  ...
  '@theojs/lumen@3.3.3':
    resolution: {integrity: sha512-rZmyutvr+hVFqqKXri7DchuF4DESU3vD5uHz/inM+6Lw5LO/KQ+xHGvz5LUhcdxlrdIOWol7lTg8Vql6r5Pseg==}
  ...
  twikoo@1.6.39:
    resolution: {integrity: sha512-gWM+gtZlHnlkGHL4ycQN1vLLuRxALwDrLVGcEOgkbKU3WX9qYf9zz/fFxbqCGvB/LTZLRuhLAc3EuwCtBI7VNQ==}
...
snapshots:
  ...
  '@vitejs/plugin-vue@5.1.4(vite@5.4.8(sass@1.79.4))(vue@3.5.11)':
    dependencies:
  ...
  vitepress-plugin-comment-with-giscus@1.1.15(vue@3.5.11):
    dependencies:
      '@giscus/vue': 2.4.0(vue@3.5.11)
    transitivePeerDependencies:
      - vue

  vitepress@1.4.0(@algolia/client-search@4.24.0)(postcss@8.4.47)(sass@1.79.4)(search-insights@2.17.2):
    dependencies:
      '@docsearch/css': 3.6.2
      '@docsearch/js': 3.6.2(@algolia/client-search@4.24.0)(search-insights@2.17.2)
      '@shikijs/core': 1.22.0
