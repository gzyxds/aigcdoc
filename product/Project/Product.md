## 👋 新一代 艺创AIGC 一站式 B/C 端解决方案。

## 🚀 **功能概述**：

- 🤖 **AI 大模型提问**、🎨 **AI 绘画**、🎥 **AI 视频生成**、📄 **文档分析**、👀 **多模态识图理解**、🎙️ **TTS & 语音识别对话**、👤 **AI 换脸**、🧠 **AI 智能体应用**、🧩 **插件系统**、🎵 **AI 音乐生成** 等一站式功能。
- 🌐 支持众多模型：
  - 🧠 **OpenAI 全模型**
  - 🎨 **Midjourney 全功能绘画**
  - 🤖 **Claude3**
  - 🔥 **讯飞星火**
  - 🐼 **豆包（Doubao-lite-4k）大模型**
  - 🖼️ **Stable Diffusion**
  - 🎨 **DALL·E（DALL-E2/E3/E4 绘画）**
  - 🐉 **ChatGLM**
  - 🌊 **通义千问**
  - 🐧 **腾讯混元**
  - 🔒 **360 智脑**
  ...
  - 💎 **Gemini**
  - 🚀 **Moonshot** 等
- ☁️ 支持 **对话会话隔离**、**云端存储**、**多设备共享数据**，以及 **弹性计费** 和 **多种计划模式**。

## ✨ **商业版私有化部署**：

- 主要面向意向搭建 AI 平台的站长和公司。若只想使用AIGC官方站，可跳过此部分。
