import{_ as s,c as a,o as p,ah as e}from"./chunks/framework.FtlWR-mB.js";const u=JSON.parse('{"title":"通用部署②/③ 开发人员使用​","description":"","frontmatter":{},"headers":[],"relativePath":"human/deployment/general.md","filePath":"human/deployment/general.md","lastUpdated":1737637816000}'),l={name:"human/deployment/general.md"};function i(r,n,c,b,t,o){return p(),a("div",null,[...n[0]||(n[0]=[e(`<h1 id="通用部署2-3-开发人员使用​" tabindex="-1">通用部署②/③ 开发人员使用<a href="https://doc.chatmoney.cn/dm/deployment/general.html#%E9%80%9A%E7%94%A8%E9%83%A8%E7%BD%B22-3" target="_blank" rel="noreferrer">​</a> <a class="header-anchor" href="#通用部署2-3-开发人员使用​" aria-label="Permalink to “通用部署②/③ 开发人员使用​”">​</a></h1><h2 id="项目入口" tabindex="-1">项目入口 <a class="header-anchor" href="#项目入口" aria-label="Permalink to “项目入口”">​</a></h2><p>项目静态资源入口目录：<code>server/public</code> 　<br> 项目PHP入口文件：<code>server/public/index.php</code></p><h2 id="php扩展" tabindex="-1">PHP扩展 <a class="header-anchor" href="#php扩展" aria-label="Permalink to “PHP扩展”">​</a></h2><p><code>fileinfo</code>、<code>PDO_MYSQL</code>、<code>allow_url_fopen</code>、<code>GD2</code>、<code>DOM</code>、<code>redis</code></p><h2 id="nginx配置" tabindex="-1">nginx配置 <a class="header-anchor" href="#nginx配置" aria-label="Permalink to “nginx配置”">​</a></h2><h3 id="nginx全配置" tabindex="-1">nginx全配置 <a class="header-anchor" href="#nginx全配置" aria-label="Permalink to “nginx全配置”">​</a></h3><div class="danger custom-block"><p class="custom-block-title">⚠️ 警告</p><p>使用过泛域名和泛域名证书，租户如果使用自定义域名，请使用自抑域名添加相当的nginx配置。</p></div><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>    server {</span></span>
...
<span class="line"><span>            }</span></span>
<span class="line"><span>    }</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br></div></div><h3 id="nginx伪静态部分" tabindex="-1">nginx伪静态部分 <a class="header-anchor" href="#nginx伪静态部分" aria-label="Permalink to “nginx伪静态部分”">​</a></h3><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span></span></span>
<span class="line"><span>    if (!-e $request_filename)</span></span>
<span class="line"><span>            {</span></span>
<span class="line"><span>                rewrite ^/(.*)$ /index.php?s=$1 last;</span></span>
<span class="line"><span>                break;</span></span>
<span class="line"><span>            }</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br></div></div><h2 id="apache配置" tabindex="-1">apache配置 <a class="header-anchor" href="#apache配置" aria-label="Permalink to “apache配置”">​</a></h2><h3 id="apache权配置" tabindex="-1">apache权配置 <a class="header-anchor" href="#apache权配置" aria-label="Permalink to “apache权配置”">​</a></h3><div class="info custom-block"><p class="custom-block-title">⚠️ 警告</p><p>使用过泛域名和泛域名证书，租户如果使用自定义域名，请使用自抑域名添加相当的apache配置。</p></div><div class="language- line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>    &lt;VirtualHost *:80&gt;</span></span>
